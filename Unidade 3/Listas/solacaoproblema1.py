...
from pylab import plot, show, xlabel, ylabel, scatter, title, legend
...
scatter(array(xpoints, float), array(ypoints, float), color='b', label='RK4')
...
scatter(array(xpoints2, float)[::20], array(ypoints2, float)[::20], color='r', label='Adaptative')
legend()
# plot(tpoints, xpoints, 'ko')
# plot(tpoints, xpoints2, 'g')
# plot(tpoints, ypoints, 'ko')
# plot(tpoints, ypoints2, 'g')
title('Órbita de Cometas')
xlabel('x (km)')
ylabel('y (km)')
show()
